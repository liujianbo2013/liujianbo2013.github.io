document.addEventListener('DOMContentLoaded', function() {    
    ...
    if (currentUrl == '/' || currentUrl.includes('/index.html') || currentUrl.includes('/page')) {
        ...
        sponsorInfo.innerHTML = '本站由 <a target="_blank" href="https://www.rainyun.com/home"><img src="https://www.rainyun.com/img/logo.d193755d.png" width="45" height="13" style="fill: currentColor;"></a> 提供 CDN 加速/云存储服务';
